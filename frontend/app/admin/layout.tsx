...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen w-full bg-white">
      <aside className="flex w-64 shrink-0 flex-col gap-8 border-r border-gray-100 px-5 py-6">
      ...
      <div className="flex-1">
        <header className="flex h-[80px] w-full items-center justify-end border-b border-gray-100 px-8">
